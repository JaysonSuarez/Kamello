    ...
    <div className="animate-fade-in-up">
      ...
      <form onSubmit={handleSubmitRequest} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        <div>
          ...
          <textarea value={description} onChange={e => setDescription(e.target.value)} placeholder="Ej: Tengo una fuga en el baño cerca al lavamanos..." className="sheet-input" style={{ height: 90, resize: "none" }} required />
